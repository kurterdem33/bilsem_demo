...
class DenemeSinaviPage3 extends StatefulWidget {
  const DenemeSinaviPage3({super.key});

  @override
  State<DenemeSinaviPage3> createState() => _DenemeSinaviPage3State();
}

class _DenemeSinaviPage3State extends State<DenemeSinaviPage3> {
  // 3. DENEME CEVAP ANAHTARI
  final List<String> _answerKey = [
    'D', 'B', 'B', 'B', 'D', 'B', 'A', 'D', 'B', 'A', // 1-10
    'C', 'C', 'A', 'B', 'D', 'C', 'B', 'C', 'A', 'B', // 11-20
    'D', 'C', 'B', 'D', 'B', 'C', 'A', 'B', 'B', 'D', // 21-30
    'D', 'C', 'C', 'D', 'A', 'D', 'A', 'C', 'B', 'B', // 31-40
    'B', 'B', 'C', 'D', 'A', 'B', 'B', 'A', 'A'       // 41-49
  ];
  ...
  void _generateQuestions() {
    ...
    for (int i = 0; i < _answerKey.length; i++) {
      ...
      _allQuestions.add({
        // Dizin "3_deneme" olarak güncellendi
        "image": "assets/images/denemeler/3_deneme/$questionNumber.jpg", 
  ...
  void _finishExam() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text("3. Deneme Bitti! 🏁", textAlign: TextAlign.center, style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
        content: Text(
